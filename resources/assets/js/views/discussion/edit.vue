...
<script>
    ...
    import {getAll,update,show,showMessage} from '../../api/index'
    export default{
        ...
        mounted(){
            ...
            show('/discussion',this.$route.params.id).then(data=>{
        ...
        methods:{
            submit(){
                ...
                update('/discussion',this.$route.params.id,data).then((data)=>{
